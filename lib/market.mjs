...
function demoSeries(symbol, index, count = 360) {
  ...
  const initialPrices = { NVDA: 122, AAPL: 181, MSFT: 426, AMZN: 196, GOOGL: 205, META: 705, TSLA: 410, "000660.KS": 172_000 };
  let price = initialPrices[symbol] || 100;
  ...
  return { symbol, currency: SYMBOLS[index]?.currency || "USD", exchangeTimezone: null, bars };
}
